...
/**
 * EquityPositionBookApiTest Class Doc Comment
 *
 * @category Class
 * @package  com\apiconnect
 * @author   Edelweiss
 * @link     https://www.edelweiss.in
 */
class EquityPositionBookApiTest extends TestCase
{
    /**
     * Test case for getNetPositions
     *
     * Retrieving NetPositions for a particular client.
     *
     */
    public function testGetNetPositions()
    {
