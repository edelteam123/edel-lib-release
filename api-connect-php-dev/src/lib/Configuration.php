...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://emtuat.edelweiss.in/edelmw-eq-uat';

    /**
     * User agent of the HTTP request, set to "{version}/PHP" by default
     *
     * @var string
     */
    ...
    {
        $report  = 'PHP SDK (com\apiconnect) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the document: v1' . PHP_EOL;
    ...
    public function getHostSettings()
    {
        return [
            [
                "url" => "https://emtuat.edelweiss.in/edelmw-eq-uat",
    ...
    /**
     * getApiKeys
     * Returns all the apikeys set using setApiKey
     * @return void
     */
    public function getApiKeys(){
        return isset($this->apiKeys) ? $this->apiKeys : null;
    }
}
