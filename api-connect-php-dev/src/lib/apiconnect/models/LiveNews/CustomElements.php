...
class CustomElements implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CustomElements';
    ...
    {
        $this->container['hghl_txt'] = $data['hghl_txt'] ?? null;
     ...
     * @return string|null
     */
    public function getHghlTxt()
    {
        return $this->container['hghl_txt'];
    }

    /**
     * Sets hghl_txt
     *
     * @param string|null $hghl_txt hghl_txt
     *
     * @return self
     */
    public function setHghlTxt($hghl_txt)
    {
        $this->container['hghl_txt'] = $hghl_txt;
