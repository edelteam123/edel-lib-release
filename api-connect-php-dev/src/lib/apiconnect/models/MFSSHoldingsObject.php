...
class MFSSHoldingsObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        ...
        'amount' => 'double',
        'mode' => 'string',
        'physHldQty' => '\com\apiconnect\apiconnect\models\PhysicalHoldingsQty[]'
    ];
     ...
     * Gets physHldQty
     *
     * @return \com\apiconnect\apiconnect\models\PhysicalHoldingsQty[]|null
     */
     ...
     * Sets physHldQty
     *
     * @param \com\apiconnect\apiconnect\models\PhysicalHoldingsQty[]|null $physHldQty Physical Holdings Quantity
     *
     * @return self
     */
