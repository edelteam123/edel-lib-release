...
class VerifyAnswersResponseDao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'accTyp' => 'string',
        'mrgSts' => 'string',
        'othAccDts' => '\com\apiconnect\apiconnect\models\OtherAccountDetailsResponseObject',
        'mrgPopUp' => 'bool',
        'mrgAccDts' => '\com\apiconnect\apiconnect\models\MergeAccountDetailsResponseObject',
        'prefAccTyp' => 'string',
        'excs' => 'string[]',
        'dfPrds' => '\com\apiconnect\apiconnect\models\DefaultProductTypesObject',
        'dfPrdsMTF' => '\com\apiconnect\apiconnect\models\DefaultProductTypesObject',
        'ordTypes' => '\com\apiconnect\apiconnect\models\KeyValueResponseObject[]',
        'sts' => 'string',
        'accs' => '\com\apiconnect\apiconnect\models\AccountDetailsResponeObject',
        'qlist' => '\com\apiconnect\apiconnect\models\QuestionsResponse[]',
        'mtf' => '\com\apiconnect\apiconnect\models\CommonConsentStatusDao',
        'comOpCnst' => '\com\apiconnect\apiconnect\models\CommonConsentStatusDao',
        'adhrEQ' => '\com\apiconnect\apiconnect\models\AadharStatusDao',
        'adhrCOM' => '\com\apiconnect\apiconnect\models\AadharStatusDao',
        'cnsntLst' => '\com\apiconnect\apiconnect\models\ConsentStatusDao[]',
        'prdcts' => 'array<string,array<string,string[]>>',
        'prds' => '\com\apiconnect\apiconnect\models\ValidityProductsResponseObject[]',
        'val' => '\com\apiconnect\apiconnect\models\ValidityExchangeObject[]',
        'gtdGtcValDays' => 'string',
        'mndtryCnsts' => '\com\apiconnect\apiconnect\models\ConsentStatusDao[]',
        'optCnsts' => '\com\apiconnect\apiconnect\models\ConsentStatusDao[]',
        'srcVendor' => 'string',
        'vndSrc' => 'string',
        'reqId' => 'string',
        'url' => 'string',
     ...
     * Gets othAccDts
     *
     * @return \com\apiconnect\apiconnect\models\OtherAccountDetailsResponseObject|null
     */
     ...
     * Sets othAccDts
     *
     * @param \com\apiconnect\apiconnect\models\OtherAccountDetailsResponseObject|null $othAccDts othAccDts
     *
     * @return self
     */
     ...
     * Gets mrgAccDts
     *
     * @return \com\apiconnect\apiconnect\models\MergeAccountDetailsResponseObject|null
     */
     ...
     * Sets mrgAccDts
     *
     * @param \com\apiconnect\apiconnect\models\MergeAccountDetailsResponseObject|null $mrgAccDts mrgAccDts
     *
     * @return self
     */
     ...
     * Gets dfPrds
     *
     * @return \com\apiconnect\apiconnect\models\DefaultProductTypesObject|null
     */
     ...
     * Sets dfPrds
     *
     * @param \com\apiconnect\apiconnect\models\DefaultProductTypesObject|null $dfPrds dfPrds
     *
     * @return self
     */
     ...
     * Sets dfPrdsMTF
     *
     * @param \com\apiconnect\apiconnect\models\DefaultProductTypesObject|null $dfPrdsMTF dfPrdsMTF
     *
     * @return self
     */
     ...
     * Gets ordTypes
     *
     * @return \com\apiconnect\apiconnect\models\KeyValueResponseObject[]|null
     */
     ...
     * Sets ordTypes
     *
     * @param \com\apiconnect\apiconnect\models\KeyValueResponseObject[]|null $ordTypes List of Order types enabled for the user
     *
     * @return self
     */
     ...
     * Gets accs
     *
     * @return \com\apiconnect\apiconnect\models\AccountDetailsResponeObject|null
     */
     ...
     * Sets accs
     *
     * @param \com\apiconnect\apiconnect\models\AccountDetailsResponeObject|null $accs accs
     *
     * @return self
     */
     ...
     * Gets qlist
     *
     * @return \com\apiconnect\apiconnect\models\QuestionsResponse[]|null
     */
     ...
     * Sets qlist
     *
     * @param \com\apiconnect\apiconnect\models\QuestionsResponse[]|null $qlist If user enters invalid answers to 2fa questions. then new set of questions comes under this field
     *
     * @return self
     */
     ...
     * Gets mtf
     *
     * @return \com\apiconnect\apiconnect\models\CommonConsentStatusDao|null
     */
     ...
     * Sets mtf
     *
     * @param \com\apiconnect\apiconnect\models\CommonConsentStatusDao|null $mtf mtf
     *
     * @return self
     */
     ...
     * Sets comOpCnst
     *
     * @param \com\apiconnect\apiconnect\models\CommonConsentStatusDao|null $comOpCnst comOpCnst
     *
     * @return self
     */
     ...
     * Gets adhrEQ
     *
     * @return \com\apiconnect\apiconnect\models\AadharStatusDao|null
     */
     ...
     * Sets adhrEQ
     *
     * @param \com\apiconnect\apiconnect\models\AadharStatusDao|null $adhrEQ adhrEQ
     *
     * @return self
     */
     ...
     * Sets adhrCOM
     *
     * @param \com\apiconnect\apiconnect\models\AadharStatusDao|null $adhrCOM adhrCOM
     *
     * @return self
     */
     ...
     * Gets cnsntLst
     *
     * @return \com\apiconnect\apiconnect\models\ConsentStatusDao[]|null
     */
     ...
     * Sets cnsntLst
     *
     * @param \com\apiconnect\apiconnect\models\ConsentStatusDao[]|null $cnsntLst consent priority List
     *
     * @return self
     */
     ...
     * Gets prds
     *
     * @return \com\apiconnect\apiconnect\models\ValidityProductsResponseObject[]|null
     */
     ...
     * Sets prds
     *
     * @param \com\apiconnect\apiconnect\models\ValidityProductsResponseObject[]|null $prds For every exchange it will give the list of validity based on product
     *
     * @return self
     */
     ...
     * Gets val
     *
     * @return \com\apiconnect\apiconnect\models\ValidityExchangeObject[]|null
     */
     ...
     * Sets val
     *
     * @param \com\apiconnect\apiconnect\models\ValidityExchangeObject[]|null $val List of validity corresponding to exchange
     *
     * @return self
     */
     ...
     * Sets mndtryCnsts
     *
     * @param \com\apiconnect\apiconnect\models\ConsentStatusDao[]|null $mndtryCnsts Mandatory consent priority List --> Won't be available if there is no mandatory consents (null check required)
     *
     * @return self
     */
     ...
     * Sets optCnsts
     *
     * @param \com\apiconnect\apiconnect\models\ConsentStatusDao[]|null $optCnsts Optional consent priority List --> Won't be available if there is a mandatory consent and no optional consents (null check required)
     *
     * @return self
     */
