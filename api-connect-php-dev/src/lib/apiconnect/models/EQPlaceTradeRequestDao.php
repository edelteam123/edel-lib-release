...
/**
 * EQPlaceTradeRequestDao Class Doc Comment
 *
 * @category Class
 * @package  com\apiconnect
 * @author   Edelweiss
 ...
 */
class EQPlaceTradeRequestDao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'EQPlaceTradeRequestDao';
    ...
    protected static $openAPITypes = [
        'trdSym' => 'string',
        'exc' => 'string',
        'action' => '\com\apiconnect\apiconnect\models\Action',
        'dur' => '\com\apiconnect\apiconnect\models\Duration',
        'flQty' => 'string',
        'ordTyp' => '\com\apiconnect\apiconnect\models\OrderType',
        'qty' => 'string',
        'dscQty' => 'string',
        'sym' => 'string',
        'mktPro' => 'string',
        'lmPrc' => 'string',
        'trgPrc' => 'string',
        'prdCode' => '\com\apiconnect\apiconnect\models\PrdCode',
        'dtDays' => 'string',
        'posSqr' => 'string',
        'minQty' => 'string',
        'ordSrc' => 'string',
     ...
     * @return string[]
     */
    public function getExcAllowableValues()
    {
        return [
            self::EXC_BSE,
            self::EXC_NSE,
    ...
    public function listInvalidProperties()
    {
        ...
        $allowedValues = $this->getExcAllowableValues();
        if (!is_null($this->container['exc']) && !in_array($this->container['exc'], $allowedValues, true)) {
            $invalidProperties[] = sprintf(
                "invalid value '%s' for 'exc', must be one of '%s'",
                $this->container['exc'],
    ...
    {
        $allowedValues = $this->getExcAllowableValues();
        if (!is_null($exc) && !in_array($exc, $allowedValues, true)) {
     ...
     * Gets action
     *
     * @return \com\apiconnect\apiconnect\models\Action|null
     */
     ...
     * Sets action
     *
     * @param \com\apiconnect\apiconnect\models\Action|null $action action
     *
     * @return self
     */
     ...
     * Gets dur
     *
     * @return \com\apiconnect\apiconnect\models\Duration|null
     */
     ...
     * Sets dur
     *
     * @param \com\apiconnect\apiconnect\models\Duration|null $dur dur
     *
     * @return self
     */
     ...
     * Gets ordTyp
     *
     * @return \com\apiconnect\apiconnect\models\OrderType|null
     */
     ...
     * Sets ordTyp
     *
     * @param \com\apiconnect\apiconnect\models\OrderType|null $ordTyp ordTyp
     *
     * @return self
     */
     ...
     * Sets qty
     *
     * @param string|null $qty Quantity in multiple of Lot size/Board lot qty
     *
     * @return self
     */
     ...
     * Sets dscQty
     *
     * @param string|null $dscQty Disclosed Quantity.<Quantity in multiple of Lot size/Board lot qty> Quantity to be disclosed publicly while order placement (default 0)
     *
     * @return self
     */
     ...
     * Gets prdCode
     *
     * @return \com\apiconnect\apiconnect\models\PrdCode|null
     */
     ...
     * Sets prdCode
     *
     * @param \com\apiconnect\apiconnect\models\PrdCode|null $prdCode prdCode
     *
     * @return self
     */
