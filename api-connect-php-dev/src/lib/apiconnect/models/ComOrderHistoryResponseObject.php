...
/**
 * ComOrderHistoryResponseObject Class Doc Comment
 *
 * @category Class
 * @package  com\apiconnect
 * @author   Edelweiss
 ...
 */
class ComOrderHistoryResponseObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'ComOrderHistoryResponseObject';
