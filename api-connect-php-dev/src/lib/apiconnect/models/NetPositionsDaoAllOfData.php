...
class NetPositionsDaoAllOfData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'type' => 'string',
        'pos' => '\com\apiconnect\apiconnect\models\NetPositionsObject[]',
        'ntMTM' => 'string',
        'tdyMtm' => 'string',
        'urlMtm' => 'string',
        'npos' => 'string',
     ...
     * Gets pos
     *
     * @return \com\apiconnect\apiconnect\models\NetPositionsObject[]|null
     */
     ...
     * Sets pos
     *
     * @param \com\apiconnect\apiconnect\models\NetPositionsObject[]|null $pos pos
     *
     * @return self
     */
