...
/**
 * OrderBookResponseObject Class Doc Comment
 *
 * @category Class
 * @package  com\apiconnect
 * @author   Edelweiss
 ...
 */
class OrderBookResponseObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'OrderBookResponseObject';
    ...
    protected static $openAPITypes = [
        ...
        'bsktOrdId' => 'string',
        'bsktEpch' => 'string',
        'brkOrd' => '\com\apiconnect\apiconnect\models\BracketOrderObject[]'
    ];
    ...
    public function __construct(array $data = null)
    {
        ...
        $this->container['brkOrd'] = $data['brkOrd'] ?? null;
    }
     ...
     * Sets dur
     *
     * @param string|null $dur Order Duration DAY/IOC/EOS etc
     *
     * @return self
     */
     ...
     * Gets brkOrd
     *
     * @return \com\apiconnect\apiconnect\models\BracketOrderObject[]|null
     */
    public function getBrkOrd()
    {
        return $this->container['brkOrd'];
    }

    /**
     * Sets brkOrd
     *
     * @param \com\apiconnect\apiconnect\models\BracketOrderObject[]|null $brkOrd brkOrd
     *
     * @return self
     */
    public function setBrkOrd($brkOrd)
    {
        $this->container['brkOrd'] = $brkOrd;
