...
/**
 * OrderDetailsResponseObject Class Doc Comment
 *
 * @category Class
 * @package  com\apiconnect
 * @author   Edelweiss
 ...
 */
class OrderDetailsResponseObject implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'OrderDetailsResponseObject';
