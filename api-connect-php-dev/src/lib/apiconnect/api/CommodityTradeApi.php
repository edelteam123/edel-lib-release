...
class CommodityTradeApi
{
     ...
     * @param  \com\apiconnect\apiconnect\models\TradeRequest $body nstOID is mandatory (required)
     *
     ...
     *
     * @param  string $userID USER ID of the client (required)
     * @param  \com\apiconnect\apiconnect\models\TradeRequest $body nstOID , exc, prdCode &amp; ordTyp are mandatory (required)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\CancelTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     ...
     *
     * @param  string $userID USER ID of the client (required)
     * @param  \com\apiconnect\apiconnect\models\TradeRequest $body nstOID, prdCode  prCodeCh , exc and ordTyp are mandatory (required)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\ConvertPositionDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     */
     ...
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\ConvertPositionDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function convertPositionCommodityWithHttpInfo($userID, $body)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\apiconnect\apiconnect\models\ConvertPositionDao' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\apiconnect\apiconnect\models\ConvertPositionDao', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\com\apiconnect\apiconnect\models\ConvertPositionDao';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\apiconnect\apiconnect\models\ConvertPositionDao',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $userID USER ID of the client (required)
     * @param  \com\apiconnect\apiconnect\models\TradeRequest $body nstOID is mandatory, At least one of dur, sym, lmPrc, orTyp, action, prCode, exc, qty, trSym is required for successful modification (required)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     ...
     *
     * @param  string $userID USER ID of the client (required)
     * @param  \com\apiconnect\apiconnect\models\TradeRequest $body nstOID is mandatory, At least one of dur, sym, lmPrc, orTyp, action, prCode, exc, qty, trSym is required for successfull modification (required)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\ModifyTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     ...
     *
     * @param  string $userID USER ID of the client (required)
     * @param  \com\apiconnect\apiconnect\models\TradeRequest $body dur, sym, lmPrc, orTyp, action, prCode, exc, qty, trSym are mandatory parameters (required)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
