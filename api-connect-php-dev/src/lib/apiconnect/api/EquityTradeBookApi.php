...
class EquityTradeBookApi
{
     ...
     * @return \com\apiconnect\apiconnect\models\EqTradeBookDao|\com\apiconnect\apiconnect\models\CommonErrorResponse|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     */
     ...
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\EqTradeBookDao|\com\apiconnect\apiconnect\models\CommonErrorResponse|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTradeBookWithHttpInfo($userID, $nOID = null)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\apiconnect\apiconnect\models\EqTradeBookDao' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\apiconnect\apiconnect\models\EqTradeBookDao', []),
            ...
            $returnType = '\com\apiconnect\apiconnect\models\EqTradeBookDao';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\apiconnect\apiconnect\models\EqTradeBookDao',
