...
/**
 * CommodityTradeBookApi Class Doc Comment
 *
 * @category Class
 * @package  com\apiconnect
 * @author   Edelweiss
...
class CommodityTradeBookApi
{
     ...
     * @param  string $nOID nOID (optional)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\ComTradeBookDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     */
    public function getTrades($userID, $nOID = null)
    {
        list($response) = $this->getTradesWithHttpInfo($userID, $nOID);
        return $response;
    }
     ...
     *
     * @param  string $userID UserId of the client (required)
     * @param  string $nOID (optional)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\ComTradeBookDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTradesWithHttpInfo($userID, $nOID = null)
    {
        $request = $this->getTradesRequest($userID, $nOID);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\apiconnect\apiconnect\models\ComTradeBookDao' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\apiconnect\apiconnect\models\ComTradeBookDao', []),
            ...
            $returnType = '\com\apiconnect\apiconnect\models\ComTradeBookDao';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\apiconnect\apiconnect\models\ComTradeBookDao',
     ...
     */
    public function getTradesRequest($userID, $nOID = null)
    {
        // verify the required parameter 'userID' is set
        if ($userID === null || (is_array($userID) && count($userID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $userID when calling getTrades'
            );
        }

        $resourcePath = '/comm/tradebook/{userID}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
