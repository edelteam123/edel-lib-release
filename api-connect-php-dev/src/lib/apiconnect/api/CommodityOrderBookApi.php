...
/**
 * CommodityOrderBookApi Class Doc Comment
 *
 * @category Class
 * @package  com\apiconnect
 * @author   Edelweiss
...
class CommodityOrderBookApi
{
     ...
     * @param  \com\apiconnect\apiconnect\models\Rtype $rTyp Request Type(COMFNO) (optional)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\ComOrderBookDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     */
    public function getOrders($userID, $rTyp = null)
    {
        list($response) = $this->getOrdersWithHttpInfo($userID, $rTyp);
        return $response;
    }
     ...
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\ComOrderBookDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getOrdersWithHttpInfo($userID, $rTyp = null)
    {
        $request = $this->getOrdersRequest($userID, $rTyp);
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\apiconnect\apiconnect\models\ComOrderBookDao' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\apiconnect\apiconnect\models\ComOrderBookDao', []),
            ...
            $returnType = '\com\apiconnect\apiconnect\models\ComOrderBookDao';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\apiconnect\apiconnect\models\ComOrderBookDao',
     ...
     */
    public function getOrdersRequest($userID, $rTyp = null)
    {
        // verify the required parameter 'userID' is set
        if ($userID === null || (is_array($userID) && count($userID) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $userID when calling getOrders'
            );
        }

        $resourcePath = '/comm/orderbook/{userID}';
        $formParams = [];
        $queryParams = [];
        $headerParams = [];
        $httpBody = '';
