...
class EquityTradeApi
{
     ...
     * @param  \com\apiconnect\apiconnect\models\EQCancelTradeRequestDao $body body (optional)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\CancelTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     */
     ...
     *
     * @param  string $userID USER ID of the client (required)
     * @param  \com\apiconnect\apiconnect\models\EQCancelTradeRequestDao $body (optional)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\CancelTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function cancelAMOTradeWithHttpInfo($userID, $body = null)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\apiconnect\apiconnect\models\CancelTradeDao' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\apiconnect\apiconnect\models\CancelTradeDao', []),
            ...
            $returnType = '\com\apiconnect\apiconnect\models\CancelTradeDao';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\apiconnect\apiconnect\models\CancelTradeDao',
     ...
     *
     * @param  string $userID USER ID of the client (required)
     * @param  \com\apiconnect\apiconnect\models\EQCancelTradeReq $body nstOID, exc, ordTyp, prdCode are mandatory (required)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\CancelTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     ...
     *
     * @param  string $userID USER ID of the client (required)
     * @param  \com\apiconnect\apiconnect\models\EQConvertPositionReq $body body (optional)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\EqConvertPositionDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     */
     ...
     *
     * @param  string $userID USER ID of the client (required)
     * @param  \com\apiconnect\apiconnect\models\EQConvertPositionReq $body (optional)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\EqConvertPositionDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function convertPositionEquityWithHttpInfo($userID, $body = null)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\apiconnect\apiconnect\models\EqConvertPositionDao' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\apiconnect\apiconnect\models\EqConvertPositionDao', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\com\apiconnect\apiconnect\models\EqConvertPositionDao';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\apiconnect\apiconnect\models\EqConvertPositionDao',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \com\apiconnect\apiconnect\models\EQPlaceTradeRequestDao $body body (optional)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\PlaceTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     */
     ...
     *
     * @param  string $userID UserId of the client (required)
     * @param  \com\apiconnect\apiconnect\models\EQPlaceTradeRequestDao $body (optional)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\PlaceTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function coverTradeWithHttpInfo($userID, $body = null)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\apiconnect\apiconnect\models\PlaceTradeDao' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\apiconnect\apiconnect\models\PlaceTradeDao', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\com\apiconnect\apiconnect\models\PlaceTradeDao';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\apiconnect\apiconnect\models\PlaceTradeDao',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $userID UserId of the client (required)
     * @param  \com\apiconnect\apiconnect\models\EQBracketExitRequestDao $body body (optional)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\CancelTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     ...
     *
     * @param  string $userID UserId of the client (required)
     * @param  \com\apiconnect\apiconnect\models\EQBracketExitRequestDao $body (optional)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\CancelTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  string $userID UserId of the client (required)
     * @param  \com\apiconnect\apiconnect\models\EQCancelTradeRequestDao $body nstOID is mandatory to exit from cover order (required)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\CancelTradeCoverDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     */
     ...
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\CancelTradeCoverDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function exitCoverTradeWithHttpInfo($userID, $body)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\apiconnect\apiconnect\models\CancelTradeCoverDao' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\apiconnect\apiconnect\models\CancelTradeCoverDao', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\com\apiconnect\apiconnect\models\CancelTradeCoverDao';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\apiconnect\apiconnect\models\CancelTradeCoverDao',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\CommAMODao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     */
     ...
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\CommAMODao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAMOFlagWithHttpInfo()
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\apiconnect\apiconnect\models\CommAMODao' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\apiconnect\apiconnect\models\CommAMODao', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\com\apiconnect\apiconnect\models\CommAMODao';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\apiconnect\apiconnect\models\CommAMODao',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $userID USER ID of the client (required)
     * @param  \com\apiconnect\apiconnect\models\EQModifyTradeRequestDao $body body (optional)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\ModifyTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     */
     ...
     *
     * @param  string $userID USER ID of the client (required)
     * @param  \com\apiconnect\apiconnect\models\EQModifyTradeRequestDao $body (optional)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\ModifyTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function modifyAMOTradeWithHttpInfo($userID, $body = null)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\apiconnect\apiconnect\models\ModifyTradeDao' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\apiconnect\apiconnect\models\ModifyTradeDao', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\com\apiconnect\apiconnect\models\ModifyTradeDao';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\apiconnect\apiconnect\models\ModifyTradeDao',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $userID USER ID of the client (required)
     * @param  \com\apiconnect\apiconnect\models\EQModifyTradeRequestDao $body body (required)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\ModifyTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     ...
     *
     * @param  string $userID USER ID of the client (required)
     * @param  \com\apiconnect\apiconnect\models\EQModifyTradeRequestDao $body (required)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\ModifyTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     ...
     * @param  \com\apiconnect\apiconnect\models\BasketOrderRequestDao $body body (optional)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\PlaceTradeBaseketDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     */
     ...
     *
     * @param  string $userID user ID (required)
     * @param  \com\apiconnect\apiconnect\models\BasketOrderRequestDao $body (optional)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\PlaceTradeBaseketDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function placeBasketOrderWithHttpInfo($userID, $body = null)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\apiconnect\apiconnect\models\PlaceTradeBaseketDao' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\apiconnect\apiconnect\models\PlaceTradeBaseketDao', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\com\apiconnect\apiconnect\models\PlaceTradeBaseketDao';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\apiconnect\apiconnect\models\PlaceTradeBaseketDao',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $userID UserId of the client (required)
     * @param  \com\apiconnect\apiconnect\models\EQBracketTradeRequestDao $body body (required)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\PlaceTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     ...
     *
     * @param  string $userID UserId of the client (required)
     * @param  \com\apiconnect\apiconnect\models\EQBracketTradeRequestDao $body (required)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\PlaceTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  string $userID UserId of the client (required)
     * @param  \com\apiconnect\apiconnect\models\PlaceGtcGtdTradeRequestDao $body body (required)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\PlaceGtcGtdTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     */
     ...
     *
     * @param  string $userID UserId of the client (required)
     * @param  \com\apiconnect\apiconnect\models\PlaceGtcGtdTradeRequestDao $body (required)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\PlaceGtcGtdTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function placeGtcGtdTradeWithHttpInfo($userID, $body)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\apiconnect\apiconnect\models\PlaceGtcGtdTradeDao' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\apiconnect\apiconnect\models\PlaceGtcGtdTradeDao', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
            ...
            $returnType = '\com\apiconnect\apiconnect\models\PlaceGtcGtdTradeDao';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\apiconnect\apiconnect\models\PlaceGtcGtdTradeDao',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     *
     * @param  string $userID UserId of the client (required)
     * @param  \com\apiconnect\apiconnect\models\EQPlaceTradeRequestDao $body body (required)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\PlaceTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse
     ...
     *
     * @param  string $userID UserId of the client (required)
     * @param  \com\apiconnect\apiconnect\models\EQPlaceTradeRequestDao $body (required)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\PlaceTradeDao|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     ...
     *
     * @param  string $userID UserId of the client (required)
     * @param  \com\apiconnect\apiconnect\models\PositionSquareOffRequestDto[] $body Position square off Request Fields (required)
     *
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\apiconnect\apiconnect\models\PositionSquareOffResponseDto|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\ErrorResponseDao|\com\apiconnect\apiconnect\models\ErrorResponseDao|\com\apiconnect\apiconnect\models\CommonErrorResponse
     */
     ...
     * @throws \com\apiconnect\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\apiconnect\apiconnect\models\PositionSquareOffResponseDto|\com\apiconnect\apiconnect\models\SessionExpired|\com\apiconnect\apiconnect\models\ErrorResponseDao|\com\apiconnect\apiconnect\models\ErrorResponseDao|\com\apiconnect\apiconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function positionSquareOffWithHttpInfo($userID, $body)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\apiconnect\apiconnect\models\PositionSquareOffResponseDto' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\apiconnect\apiconnect\models\PositionSquareOffResponseDto', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 401:
                ...
                case 403:
                    if ('\com\apiconnect\apiconnect\models\ErrorResponseDao' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\apiconnect\apiconnect\models\ErrorResponseDao', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 500:
            ...
            $returnType = '\com\apiconnect\apiconnect\models\PositionSquareOffResponseDto';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\apiconnect\apiconnect\models\PositionSquareOffResponseDto',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
                ...
                case 403:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\apiconnect\apiconnect\models\ErrorResponseDao',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
