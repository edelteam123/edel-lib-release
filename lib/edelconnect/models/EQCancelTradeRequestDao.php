...
/**
 * EQCancelTradeRequestDao Class Doc Comment
 *
 * @category Class
 * @package  com\edel
 * @author   Edelweiss
 ...
 */
class EQCancelTradeRequestDao implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'EQCancelTradeRequestDao';
