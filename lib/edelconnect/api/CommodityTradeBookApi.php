...
class CommodityTradeBookApi
{
     ...
     * @return \com\edel\edelconnect\models\ComTradeBookDao|\com\edel\edelconnect\models\SessionExpired|\com\edel\edelconnect\models\CommonErrorResponse
     */
     ...
     * @throws \com\edel\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\edel\edelconnect\models\ComTradeBookDao|\com\edel\edelconnect\models\SessionExpired|\com\edel\edelconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getTradesWithHttpInfo($userID, $nOID = null)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\edel\edelconnect\models\ComTradeBookDao' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\edel\edelconnect\models\ComTradeBookDao', []),
            ...
            $returnType = '\com\edel\edelconnect\models\ComTradeBookDao';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\edel\edelconnect\models\ComTradeBookDao',
