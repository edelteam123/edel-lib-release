...
class MFHoldingsApi
{
     ...
     * @return \com\edel\edelconnect\models\MFHoldingsResponseDao|\com\edel\edelconnect\models\CommonErrorResponse
     */
     ...
     * @throws \com\edel\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\edel\edelconnect\models\MFHoldingsResponseDao|\com\edel\edelconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function getAllHoldingsWithHttpInfo($userId)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\edel\edelconnect\models\MFHoldingsResponseDao' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\edel\edelconnect\models\MFHoldingsResponseDao', []),
            ...
            $returnType = '\com\edel\edelconnect\models\MFHoldingsResponseDao';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\edel\edelconnect\models\MFHoldingsResponseDao',
