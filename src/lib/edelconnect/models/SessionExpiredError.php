...
/**
 * SessionExpiredError Class Doc Comment
 *
 * @category Class
 * @package  com\edel
 * @author   Edelweiss
 ...
 */
class SessionExpiredError implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'SessionExpired_error';
