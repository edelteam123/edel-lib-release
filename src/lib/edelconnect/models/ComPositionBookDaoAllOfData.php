...
class ComPositionBookDaoAllOfData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'type' => 'string',
        'pos' => '\com\edel\edelconnect\models\ComPositionBookObject[]',
        'ntMTM' => 'string',
        'tdyMtm' => 'string',
        'urlMtm' => 'string',
        'npos' => 'string',
     ...
     * Gets pos
     *
     * @return \com\edel\edelconnect\models\ComPositionBookObject[]|null
     */
     ...
     * Sets pos
     *
     * @param \com\edel\edelconnect\models\ComPositionBookObject[]|null $pos pos
     *
     * @return self
     */
