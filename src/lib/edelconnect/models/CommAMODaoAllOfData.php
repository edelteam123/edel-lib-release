...
/**
 * CommAMODaoAllOfData Class Doc Comment
 *
 * @category Class
 * @package  com\edel
 * @author   Edelweiss
 ...
 */
class CommAMODaoAllOfData implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'CommAMODao_allOf_data';
