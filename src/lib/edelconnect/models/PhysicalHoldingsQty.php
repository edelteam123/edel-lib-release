...
/**
 * PhysicalHoldingsQty Class Doc Comment
 *
 * @category Class
 * @package  com\edel
 * @author   Edelweiss
 ...
 */
class PhysicalHoldingsQty implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'PhysicalHoldingsQty';
