...
/**
 * ValidateUidPwdRequest Class Doc Comment
 *
 * @category Class
 * @package  com\edel
 * @author   Edelweiss
 ...
 */
class ValidateUidPwdRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    /**
      ...
      * @var string
      */
    protected static $modelName = 'ValidateUidPwdRequest';
     ...
     * Sets pwd
     *
     * @param string $pwd API secret (password)
     *
     * @return self
     */
