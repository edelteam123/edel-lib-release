...
class CommonLoginApi
{
     ...
     * URL: https://emtuat.edelweiss.in/edelmw-login-uat/login
     *
     * @param  string $userID userID (required)
     *
     * @throws \com\edel\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\edel\edelconnect\models\LogOutDao|\com\edel\edelconnect\models\CommonErrorResponse
     */
     ...
     * @throws \com\edel\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\edel\edelconnect\models\LogOutDao|\com\edel\edelconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function endSessionWithHttpInfo($userID)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\edel\edelconnect\models\LogOutDao' === '\SplFileObject') {
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\edel\edelconnect\models\LogOutDao', []),
            ...
            $returnType = '\com\edel\edelconnect\models\LogOutDao';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\edel\edelconnect\models\LogOutDao',
     ...
     * @param  \com\edel\edelconnect\models\LoginAuthDataRequestDto $body body (optional)
     *
     * @throws \com\edel\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\edel\edelconnect\models\LoginAuthDataResponse|\com\edel\edelconnect\models\CommonErrorResponse|\com\edel\edelconnect\models\CommonErrorResponse
     */
     ...
     * @param  string $sourceToken key obtained from the generate sesion. (required)
     * @param  string $appIdKey key obtained from the generate sesion. (required)
     * @param  \com\edel\edelconnect\models\LoginAuthDataRequestDto $body (optional)
     *
     * @throws \com\edel\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\edel\edelconnect\models\LoginAuthDataResponse|\com\edel\edelconnect\models\CommonErrorResponse|\com\edel\edelconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function loginDataWithHttpInfo($sourceToken, $appIdKey, $body = null)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\edel\edelconnect\models\LoginAuthDataResponse' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\edel\edelconnect\models\LoginAuthDataResponse', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                case 222:
            ...
            $returnType = '\com\edel\edelconnect\models\LoginAuthDataResponse';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\edel\edelconnect\models\LoginAuthDataResponse',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
     ...
     * @param  \com\edel\edelconnect\models\ValidateUidPwdRequest $body body (required)
     *
     * @throws \com\edel\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return \com\edel\edelconnect\models\GnrResDao|\com\edel\edelconnect\models\CommonErrorResponse
     */
     ...
     * @param  \com\edel\edelconnect\models\ValidateUidPwdRequest $body (required)
     *
     * @throws \com\edel\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\edel\edelconnect\models\GnrResDao|\com\edel\edelconnect\models\CommonErrorResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function validateVendorCrdntialsWithHttpInfo($vendorID, $source, $body)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\edel\edelconnect\models\GnrResDao' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    ...
                    return [
                        ObjectSerializer::deserialize($content, '\com\edel\edelconnect\models\GnrResDao', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
                default:
            ...
            $returnType = '\com\edel\edelconnect\models\GnrResDao';
            if ($returnType === '\SplFileObject') {
                $content = $response->getBody(); //stream goes to serializer
            } else {
                $content = (string) $response->getBody();
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\edel\edelconnect\models\GnrResDao',
                        $e->getResponseHeaders()
                    );
                    $e->setResponseObject($data);
                    break;
