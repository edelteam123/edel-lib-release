...
class ChartsContentApi
{
     ...
     * @return \com\edel\edelconnect\models\ChartsResponseDao
     */
     ...
     * @throws \com\edel\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return array of \com\edel\edelconnect\models\ChartsResponseDao, HTTP status code, HTTP response headers (array of strings)
     */
    private function getScripChartDataWithHttpInfo($data)
    {
        ...
        try {
            ...
            switch ($statusCode) {
                case 200:
                    if ('\com\edel\edelconnect\models\ChartsDataDao' === '\SplFileObject') {
                        $content = $response->getBody(); //stream goes to serializer
                    } else {
                        $content = (string) $response->getBody();
                    }
                    return [
                        ObjectSerializer::deserialize($content, '\com\edel\edelconnect\models\ChartsDataDao', []),
                        $response->getStatusCode(),
                        $response->getHeaders()
                    ];
            }

            $returnType = '\com\edel\edelconnect\models\ChartsDataDao';
            ...
            switch ($e->getCode()) {
                case 200:
                    $data = ObjectSerializer::deserialize(
                        $e->getResponseBody(),
                        '\com\edel\edelconnect\models\ChartsDataDao',
